...
import {TranslateFn} from "../../context";

export default function FacetsSection({children, translate}: { children: ReactNode, translate?: TranslateFn }) {
...
function FacetsToggleButton({toggleFacets, translate}: { toggleFacets: () => void, translate?: TranslateFn }) {
    return (
        <button className="lg:hidden flex gap-1 items-center bg-neutral-100 rounded-full px-2 py-1"
            ...
            {translate ? translate('faceted-search-react.facets.toggle.button.searchFilters') : 'Search filters'}
