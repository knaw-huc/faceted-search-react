...
function FacetsToggleButton({toggleFacets}: { toggleFacets: () => void }) {
    ...
    return (
        <Button className="lg:hidden flex gap-1 items-center bg-neutral-100 rounded-full px-2 py-1"
            ...
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 fill-neutral-800">
                <path
            ...
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 fill-neutral-800">
...
function FacetsCloseButton({closeFacets}: { closeFacets: () => void }) {
    return (
        <button className="lg:hidden" onClick={closeFacets}>
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 fill-diploblue-neutral-800">
                <path fillRule="evenodd"
